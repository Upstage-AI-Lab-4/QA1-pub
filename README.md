...
이번 프로젝트에서는 스마트하고 사용자 친화적인 QA 엔진을 만들어 복잡한 의료 법률 문제를 효과적으로 처리하는 것을 목표로 했습니다. 이를 위해 저희 팀은 한국어에 특화되어 임베딩을 제공하는 Solar LLM 모델과 정확하고 관련성 높은 답변을 제공하는 RAG 기술을 사용했습니다. 또 이러한 기술 조정을 위한 LangChain과 효율적인 데이터 관리를 위한 RDB와 통합함으로써 유연한 솔루션을 보장하도록 설계했습니다.
<br>
